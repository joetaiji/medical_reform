$(function () {  	
	...
	//콘텐츠의 첫번째로 info-box가 오는 경우 contents_title의 아래여백을 다르게 설정
	const firstCont = $(".page-contents").children().first();
	firstCont.hasClass('info-box') ? $(".title-1").addClass('with-info') : "";
